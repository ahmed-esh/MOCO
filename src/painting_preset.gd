...
func animate_clue_discovery1(start_pos: Vector2, target_pos: Vector2):
	...
	tween.tween_property(UiOfCamelSolutions.CamelClue1, "scale", Vector2(0.2, 0.2), 0.4).set_trans(Tween.TRANS_BACK).set_ease(Tween.EASE_OUT)
...
func animate_clue_discovery2(start_pos: Vector2, target_pos: Vector2):
	...
	tween.tween_property(UiOfCamelSolutions.CamelClue2, "scale", Vector2(0.2, 0.2), 0.4).set_trans(Tween.TRANS_BACK).set_ease(Tween.EASE_OUT)
